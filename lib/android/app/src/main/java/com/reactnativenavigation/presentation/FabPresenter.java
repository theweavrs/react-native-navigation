...
import static com.reactnativenavigation.fab.FloatingActionButton.SIZE_MINI;
import static com.reactnativenavigation.fab.FloatingActionButton.SIZE_NORMAL;
import static com.reactnativenavigation.fab.FloatingActionButton.SIZE_BIG;
...
public class FabPresenter {
    ...
    public void applyOptions(FabOptions options, @NonNull ReactComponent component, @NonNull ViewGroup viewGroup) {
        ...
        if (options.id.hasValue()) {
            if (fabMenu != null && fabMenu.getFabId().equals(options.id.get())) {
                ...
                fab.setOnClickListener(v -> component.sendOnNavigationButtonPressed(
                        options.params.hasValue() ? options.params.get() : options.id.get()));
            } else {
                createFab(options);
            }
        } else {
    ...
    private void setParams(View fab, FabOptions options) {
        ...
        if (viewGroup instanceof RelativeLayout) {
            ...
            layoutParamsRelative.bottomMargin = (int) viewGroup.getContext().getResources().getDimension(R.dimen.bottom_margin);
            ...
            if (options.alignHorizontally.hasValue()) {
                if ("right".equals(options.alignHorizontally.get())) {
                    ...
                    layoutParamsRelative.removeRule(CENTER_IN_PARENT);
                ...
                if ("center".equals(options.alignHorizontally.get())) {
                    layoutParamsRelative.removeRule(ALIGN_PARENT_RIGHT);
                    layoutParamsRelative.removeRule(ALIGN_PARENT_LEFT);
                    layoutParamsRelative.addRule(CENTER_IN_PARENT);
                }
            } else {
                layoutParamsRelative.addRule(ALIGN_PARENT_RIGHT);
            }
        ...
        if (viewGroup instanceof FrameLayout) {
            FrameLayout.LayoutParams layoutParamsFrame = new FrameLayout.LayoutParams(
                    ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            layoutParamsFrame.bottomMargin = (int) viewGroup.getContext().getResources()
                    .getDimension(R.dimen.bottom_margin);
            ...
            if (options.alignHorizontally.hasValue()) {
                if ("right".equals(options.alignHorizontally.get())) {
                    ...
                    removeGravityParam(layoutParamsFrame, Gravity.CENTER);
                ...
                if ("center".equals(options.alignHorizontally.get())) {
                    removeGravityParam(layoutParamsFrame, Gravity.RIGHT);
                    removeGravityParam(layoutParamsFrame, Gravity.LEFT);
                    setGravityParam(layoutParamsFrame, Gravity.CENTER);
                }
            } else {
                setGravityParam(layoutParamsFrame, Gravity.RIGHT);
            }
    ...
    private void mergeParams(View fab, FabOptions options) {
        ...
        if (viewGroup instanceof RelativeLayout) {
            ...
            if (layoutParamsRelative == null) {
                layoutParamsRelative = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                        ViewGroup.LayoutParams.WRAP_CONTENT);
                layoutParamsRelative.bottomMargin = (int) viewGroup.getContext().getResources()
                        .getDimension(R.dimen.bottom_margin);
                layoutParamsRelative.rightMargin = (int) viewGroup.getContext().getResources()
                        .getDimension(R.dimen.margin);
                layoutParamsRelative.leftMargin = (int) viewGroup.getContext().getResources()
                        .getDimension(R.dimen.margin);
        ...
        if (viewGroup instanceof FrameLayout) {
            ...
            if (layoutParamsFrame == null) {
                layoutParamsFrame = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                        ViewGroup.LayoutParams.WRAP_CONTENT);
                layoutParamsFrame.bottomMargin = (int) viewGroup.getContext().getResources()
                        .getDimension(R.dimen.bottom_margin);
                layoutParamsFrame.rightMargin = (int) viewGroup.getContext().getResources()
                        .getDimension(R.dimen.margin);
                layoutParamsFrame.leftMargin = (int) viewGroup.getContext().getResources().getDimension(R.dimen.margin);
                layoutParamsFrame.topMargin = (int) viewGroup.getContext().getResources().getDimension(R.dimen.margin);
            }
    ...
    private void applyFabOptions(Fab fab, FabOptions options) {
        ...
        if (options.text.hasValue() && options.fontSize.hasValue() && options.textColor.hasValue()) {
            fab.applyIcon(null, options.text.get(), options.fontSize.get(), options.textColor.get());
        }
        ...
        if (options.icon.hasValue()) {
            fab.applyIcon(options.icon.get(), null, 0, 0);
        }
        if (options.size.hasValue()) {
            fab.setButtonSize("mini".equals(options.size.get()) ? SIZE_MINI
                    : "big".equals(options.size.get()) ? SIZE_BIG : SIZE_NORMAL);
        }
    ...
    private void applyFabMenuOptions(FabMenu fabMenu, FabOptions options) {
        ...
        if (options.size.hasValue()) {
            fabMenu.setMenuButtonSize("mini".equals(options.size.get()) ? SIZE_MINI
                    : "big".equals(options.size.get()) ? SIZE_BIG : SIZE_NORMAL);
        }
        ...
        for (FabOptions fabOption : options.actionsArray) {
            ...
            fab.setOnClickListener(v -> component.sendOnNavigationButtonPressed(
                    fabOption.params.hasValue() ? fabOption.params.get() : fabOption.id.get()));
        ...
        if (options.menuBackgroundColor.hasValue()) {
            fabMenu.setBackgroundDimColor(options.menuBackgroundColor.get());
        }
    }
