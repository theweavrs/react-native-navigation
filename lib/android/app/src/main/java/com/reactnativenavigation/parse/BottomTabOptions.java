...
public class BottomTabOptions {
    ...
    void mergeWith(final BottomTabOptions other) {
        ...
        if (other.selectedTextColor.hasValue())
    ...
    void mergeWithDefault(final BottomTabOptions defaultOptions) {
        ...
        if (!selectedTextColor.hasValue())
            selectedTextColor = defaultOptions.selectedTextColor;
        if (!icon.hasValue())
        ...
        if (!selectedIconColor.hasValue())
            selectedIconColor = defaultOptions.selectedIconColor;
        if (!badge.hasValue())
            badge = defaultOptions.badge;
        if (!badgeColor.hasValue())
            badgeColor = defaultOptions.badgeColor;
        if (!fontSize.hasValue())
            fontSize = defaultOptions.fontSize;
        if (!selectedFontSize.hasValue())
            selectedFontSize = defaultOptions.selectedFontSize;
        if (fontFamily == null)
